...
const tips = [
    ...
    "💡 Consejo: Recuerda que la primer casilla en revelarse nunca será una mina 💣, ¡aprovecha para abrir una zona segura!",
    ...
    "💡 Consejo: Toma un vaso de agua 🫗 puede alivianar el estrés",
    "💡 Consejo: Recuerda tomar descansos de vez en cuando",
    "💡 Consejo: Si dudas, pon una marca ❔. Mejor prevenir que explotar una mina 💣.",
    "💡 Consejo: La lógica gana más que la suerte 🍀. ¡Piensa antes de revelar una casilla!",
    ...
    "💡 Consejo: Si, podrías ganar haciendo revelando casillas aleatoriamente y con una suerte 🍀 impresionante, pero no lo llames estrategia",
    ...
    "💡 Consejo: Hacer revelar casillas aleatoriamente también es una estrategia, ¿no?",
